...
/// Implements <see cref="IDisposable"/> and <see cref="IAsyncDisposable"/> to allow proper resource management and disposal.
/// </summary>
public interface IPresenter : IDisposable, IAsyncDisposable
{
}
}